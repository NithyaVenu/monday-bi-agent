...
//       {/* Chat Panel */}
//       <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "20px", maxWidth: "700px", margin: "0 auto" }}>
//         <h2>Monday.com BI Agent</h2>
//         <div style={{ flex: 1, overflowY: "auto", border: "1px solid #ddd", borderRadius: "8px", padding: "16px", marginBottom: "12px" }}>
//           {messages.map((m, i) => (
...
//                 background: m.role === "user" ? "#0073ea" : "#f0f0f0",
...
//                   <button onClick={() => setShowTrace(m.trace!)} style={{ fontSize: "12px", color: "#0073ea", background: "none", border: "none", cursor: "pointer" }}>
//                     🔍 View agent trace ({m.trace.length} calls)
//                   </button>
//                 </div>
//               )}
//             </div>
...
//           />
//           <button onClick={sendMessage} style={{ padding: "10px 20px", background: "#0073ea", color: "white", border: "none", borderRadius: "8px", cursor: "pointer" }}>
//             Send
//           </button>
//         </div>
//       </div>
...
//       {/* Trace Panel */}
//       {showTrace && (
//         <div style={{ width: "320px", borderLeft: "1px solid #ddd", padding: "20px", overflowY: "auto", background: "#fafafa" }}>
//           <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
//             <h3>Agent Trace</h3>
//             <button onClick={() => setShowTrace(null)} style={{ background: "none", border: "none", cursor: "pointer", fontSize: "18px" }}>✕</button>
//           </div>
//           {showTrace.map((t, i) => (
//             <div key={i} style={{ background: "white", border: "1px solid #eee", borderRadius: "8px", padding: "12px", marginBottom: "8px" }}>
//               <div style={{ fontWeight: "bold" }}>🔧 {t.tool}</div>
//               <div style={{ color: "#666", fontSize: "13px" }}>Status: {t.status}</div>
//               {t.records_returned !== undefined && <div style={{ fontSize: "13px" }}>Records: {t.records_returned}</div>}
//             </div>
//           ))}
//         </div>
//       )}
